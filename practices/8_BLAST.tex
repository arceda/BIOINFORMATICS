...
\begin{document}
	...
	\begin{enumerate}
		...
		\item 
		 ...
		 Construya una pequeña base de datos de ADN's o aminoacidos. Puede utilizar secuencias de \href{https://www.uniprot.org/}{UniProt}, \href{http://castor.bioinfo.uqam.ca/}{Castor} o las que usted desee.
		 
		 \item
		 Implemente el algoritmo original de BLAST y evalue sus resultados en la base de datos construida anteriormente. 
